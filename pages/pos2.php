...
<style>
    ...
    .in-stack-image {
        ...
        overflow: hidden;
        border-radius: 5px;
        margin-top: -30px; /* To overlap the main image */
    }
    .in-stack-image img {
        width: 100%;
        height: 100%;
...
<div class="container-fluid">
   ...
   <div class="d-sm-flex align-items-center justify-content-between mb-4">
      <h1 class="h3 mb-0 text-gray-800 col-12">
            ...
            <div class="row float-right">
                <div class="col-12">
                    <button class="btn btn-outline-secondary" data-toggle="modal" data-target="#create-stock-modal" id="create-stock"><i class="fa fa-plus"></i> Create Stock</button>
                    <button class="btn btn-outline-primary" data-toggle="modal" data-target="#convertion-modal" id="v-convertion"><i class="fa fa-plus"></i> Stock Converter</button>
                    <button class="btn btn-outline-success" data-toggle="modal" data-target="#material-convertion-modal" id="v-m-convertion"><i class="fa fa-plus"></i> Material Converter</button>
                    <button class="btn btn-outline-info" data-toggle="modal" data-target="#transaction-history" id="v-transaction"><i class="fa fa-list"></i> Transaction List</button>
                </div>
            </div>
      </h1>
   </div>
    ...
    <div class="modal fade" id="displayConvertion" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Product Conversion</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
                </div>
                <div class="modal-body">
                    <div class="col-12 text-center" id="convertion-loading" style="max-height: 400px;overflow-y:auto;">
                        <i class="fa fa-spinner fa-spin"></i> Please wait ... 
                    </div>
                    <div class="col-12 hidden" style="max-height: 400px;overflow-y:auto;">
                        <table class="table table-bordered" id="convertion-container">
                            <thead>
                                <tr>
                                    <th>Product</th>
                                    <th>Type</th>
   ...
   <div class="row">
            ...
            <div class="card">
                <div class="card-header bg-default">
                    <div class="form-group col">
                        ...
                        <select class="form-control" id="product_type" name="product_type" aria-describedby="product_type" multiple></select>
                    </div>
                </div>
                <div class="card-body" style="height:70vh; max-height: 70vh;;overflow:auto">
        ...
        <div class="col-5">
            <div class="card">
                <div class="card-header bg-default" id="transaction-header"></div>
                <div class="card-header bg-default table-container ">
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Item</th>
                ...
                <div class="card-body" style="overflow:auto;"> 
                    <div class="row">
                        <div class="col-12 lead mb-3" style="font-size:15px;"> 
...
<div class="modal fade" id="convertion-modal">
    <div class="modal-dialog modal-lg">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
            <h4 class="modal-title">Convert Stock to Relative Units</h4>
        ...
        <div class="modal-body">
            <div class="input-group mb-3 float-right col-6">
                ...
                <input type="text" class="form-control" id="product-search-convertion" aria-describedby="basic-addon3">
            </div>
            <div class="col-12 text-center" id="menu-convertion-loading" style="max-height: 400px;overflow-y:auto;">
                <i class="fa fa-spinner fa-spin"></i> Please wait ... 
            </div>
            <div class="col-12 hidden" style="max-height: 400px;overflow-y:auto;">
                <table class="table table-bordered" id="product-container-w-convertion">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Code</th>
        ...
        <!-- Modal footer -->
        <div class="modal-footer">
            <button type="button" class="btn btn-primary hidden" data-dismiss="modal">Convert</button>
...
<div class="modal fade" id="material-convertion-modal">
    <div class="modal-dialog modal-lg">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
            <h4 class="modal-title">Convert material to stock</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <div class="modal-body">
            ...
            <div class="col-12 text-center" id="material-loading" style="max-height: 400px;overflow-y:auto;">
                <i class="fa fa-spinner fa-spin"></i> Please wait ... 
            </div>
            <div class="col-12 hidden" style="max-height: 400px;overflow-y:auto;">
                <table class="table table-bordered" id="material-container">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Code</th>
...
<div class="modal fade" id="create-stock-modal">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-body">
            ...
            <div class="col-12 text-center" id="create-stock-loading" style="max-height: 400px;overflow-y:auto;">
                <i class="fa fa-spinner fa-spin"></i> Please wait ... 
            </div>
            <div class="col-12 hidden" style="max-height: 400px;overflow-y:auto;">
                <table class="table table-bordered" id="create-stock-container">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Code</th>
