                        ...
                        Swal.fire({
                            ...
                            html: `
                                    <div class="col-12 text-left">
                                        ...
                                        <h4>Product Type : ${value.productType}</h4>
                                        <h4>Product Price : ${value.selling_price}</h4>
                                        <h4>Unit : ${value.unit} (${value.abbreviations})</h4>
                                        <h4>In Stack : ${value.total}</h4>
                                    </div>
                                    <div class="col-12">
                ...
                $.each(stockData,function(key,value){
                    ...
                    $("#product-container tbody").append(
                        ...
                        .append(
                            ...
                            $("<td>").text(`${value.total - usedStocks}`),
                        )
                    )
