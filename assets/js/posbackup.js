                                            ...
                                            $("<div>")
                                                ...
                                                .append(
                                                    $("<img>")
                                                        ...
                                                        .attr({
                                                            src:`${baseUrl}/uploads/product/${value.productid}/${value.image}`,
                                                        })
                                                ),
                                            // $("<div>")
                                            //     .addClass("card__name")
                                            //     .append(
                                            //         $("<p>").text(value.product_name)
                                            //     ),
                                            $("<div>")
                                                .addClass("")
                                                .append(
                                            ...
                                            (async () => {
                                                ...
                                                if (quantity) {
                                                    ...
                                                    if(!objectMenu.hasOwnProperty(value.menuId)){
                                                        ...
                                                        let newPrice = parseFloat(objectMenu[value.menuId].total_price) + parseFloat(value.selling_price);
                                                        let newName = `${value.product_name} x(${newPrice / value.selling_price})`
                                                        objectMenu[value.menuId] = {
                                                    ...
                                                    subtotal += parseFloat(value.selling_price) * quantity;
                                                    ...
                                                    .append(
                                                        $("<tr>")
                                                            .append(
                                                                $("<td>")
                                                                    .text(`${value.product_name} (${value.menuType})`),
                                                                $("<td>")
                                                                    .append(
                                                                        $("<span>")
                                                                        .text(value.selling_price),
                                                                ...
                                                                .append(
                                                                    $("<span>")
                                                                    .text(parseFloat(value.selling_price) * parseFloat(quantity)),
                                                                ),
                                                                $("<td>")
                                                                        ...
                                                                        .click(function(){
                                                                            ...
                                                                            (async () => {
                                                                                ...
                                                                                if (quantity) {
                                                                                        ...
                                                                                        $this.parents("tr").find('td:eq(3)').text(value.selling_price * quantity)
                                                                                        pos.display.calculatePOS();
                                                                                    }
                                                                                })()
                                                                        }),
                                                                        ...
                                                                        .click(function(){
                                                                            ...
                                                                            Swal.fire({
                                                                                ...
                                                                                if (result.value) {
                                                                                    ...
                                                                                    let total = objectMenu[value.menuId].selling_price * objectMenu[value.menuId].quantity;
